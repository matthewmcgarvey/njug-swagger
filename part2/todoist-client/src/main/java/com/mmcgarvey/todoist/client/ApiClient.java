package com.mmcgarvey.todoist.client;
...
import com.mmcgarvey.todoist.client.auth.*;
import com.mmcgarvey.todoist.client.auth.OAuth.AccessTokenListener;
...
public class ApiClient {
  ...
  private String basePath = "https://beta.todoist.com/API/v8";
